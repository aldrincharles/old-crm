...
import { useTableDispatch, pageNext } from "./context/TableProvider";

export const SearchAnalyticsFilters = () => {
  ...
  return (
    <Form onSubmit={onSubmit}>
      ...
      <div style={{ textAlign: "left" }}>
        ...
        <FormGroup>
          <Label for="organization_industry">Organization Industry:</Label>
          <AsyncSelectWrap
        ...
        <FormGroup>
          <Label for="organization_vertical">Organization Vertical:</Label>
          <AsyncSelectWrap
            name="organization_vertical"
            dependencies={{ url: "/parameters", topic: "vertical" }}
            value={form.organization_vertical || ""}
            onChange={(event) => onChange("organization_vertical", event)}
            isMulti
          />
        </FormGroup>
        <FormGroup>
