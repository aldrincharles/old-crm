...
const interviewOption = [
  ...
  { value: "Done - Move to In-Depth IV", label: "Done - Move to In-Depth IV" },
];
...
export const InternalInterviewScreenDisplay = ({
  data,
  handleUpdate = () => null,
  onSelectRows = () => null,
    ...
    () => [
        ...
        Cell: ({ row, column: { id }, updateMyData }) => {
          ...
          const handleOnChange = async (data) => {
            const response = authAxios.post(
              `/jobs/reachout/update-interview-status/screen-iv/${reachout_id}`,
              {
                status: data,
              }
            );
      ...
      },
      {
        ...
        Cell: ({ row, updateMyData }) => {
          ...
          return (
            <>
              <InterviewDetails
                url={`/jobs/reachout/update-internal-interview/screen-iv/${row.original.reachout_id}`}
      ...
      },
      {
        ...
        Cell: ({ row, column: { id }, updateMyData }) => {
          ...
          const handleOnChange = async (data) => {
            const response = authAxios.post(
              `/jobs/reachout/update-info-pack/screen-iv/${reachout_id}`,
              {
                info_pack: data,
              }
            );
